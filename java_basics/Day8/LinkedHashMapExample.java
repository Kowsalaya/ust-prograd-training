...
public class LinkedHashMapExample
{
    ...
    public static void main(String args[])
    {
        ...
        LinkedHashMapExample linkedHashMap = new LinkedHashMapExample();
        linkedHashMap.buildAdjMatrix(A);
        TreeSet<String>temp = linkedHashMap.solve(A, new Pair(0,0), new HashSet<Pair>() );
        for(String t : temp)
        {
