...
public class WalletTest {
    ...
    class verifyWithdrawFunctionality {
        ...
        @Test
        public void verifyWithdrawFunctionalityWithSingleWithdrawal() throws Wallet.InsufficientFundsException {
            wallet.deposit(50);
            Assertions.assertEquals(50, wallet.getBalance());
            wallet.withdraw(10);
        ...
        @Test
        public void verifyWithdrawFunctionalityWithMultipleWithdrawal() throws Wallet.InsufficientFundsException {
            wallet.deposit(50);
            Assertions.assertEquals(50, wallet.getBalance());
            wallet.withdraw(10);
            Assertions.assertEquals(40, wallet.getBalance());
